...
const highlights = [
  {
    ...
    description: 'List your items in seconds and reach buyers instantly across the platform.',
    stat: '< 30s',
  ...
  },
  {
    ...
    description: 'Every payment is protected with industry-standard encryption and buyer guarantees.',
    stat: '100%',
  ...
  },
  {
    icon: TrendingUp,
    title: 'Smart Pricing',
    description: 'AI-powered pricing insights help you set the right price and sell faster.',
    stat: '3x',
